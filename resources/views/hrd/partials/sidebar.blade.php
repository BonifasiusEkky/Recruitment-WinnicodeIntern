...
<aside class="main-sidebar elevation-4 spark-sidebar">
    ...
    <div class="sidebar">
        ...
        @php
            $isJobsOpen = request()->routeIs('hrd.jobs.*');
            $isApplicationsOpen = request()->routeIs('hrd.jobs.applications.*');
        @endphp
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column"
                ...
                {{-- Application --}}
                <li class="nav-item has-treeview {{ $isApplicationsOpen ? 'menu-open' : '' }}">
                    <a href="#"
                       class="nav-link {{ $isApplicationsOpen ? 'active' : '' }}">
                        <i class="nav-icon fas fa-briefcase"></i>
                        <p>
                            Application
                            <i class="right fas fa-angle-down"></i>
